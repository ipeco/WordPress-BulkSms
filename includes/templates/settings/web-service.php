			...
			<tr>
				<td>
					<p class="submit">
						...
						<input type="hidden" name="page_options" value="wordpress_smsir_webservice,wordpress_smsir_username,wordpress_smsir_password,wordpress_smsir_key,wordpress_smsir_number,wordpress_smsir_stcc_number" />
