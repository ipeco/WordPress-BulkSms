...
<div class="wrap">
	<h2 class="nav-tab-wrapper">
		<a href="?page=wordpress_smsir/setting" class="nav-tab<?php if($_GET['tab'] == '') { echo " nav-tab-active";} ?>"><?php _e('General', 'wordpress_smsir'); ?></a>
		<a href="?page=wordpress_smsir/setting&tab=web-service" class="nav-tab<?php if($_GET['tab'] == 'web-service') { echo " nav-tab-active"; } ?>"><?php _e('Web Service', 'wordpress_smsir'); ?></a>
		<a href="?page=wordpress_smsir/setting&tab=newsletter" class="nav-tab<?php if($_GET['tab'] == 'newsletter') { echo " nav-tab-active"; } ?>"><?php _e('Newsletter', 'wordpress_smsir'); ?></a>
	...
	<table class="form-table">
		<form method="post" action="options.php" name="form">
			...
			<?php if( get_option('wordpress_smsir_subscribes_send') ) { $hidden=""; } else { $hidden=" style='display: none;'"; }?>
			...
			<tr>
				...
				<td>
					...
					<?php if( get_option('wordpress_smsir_nrnu_stats') ) { $hidden=""; } else { $hidden=" style='display: none;'"; }?>
			...
			<?php if( get_option('wordpress_smsir_gnc_stats') ) { $hidden=""; } else { $hidden=" style='display: none;'"; }?>
			...
			<?php if( get_option('wordpress_smsir_ul_stats') ) { $hidden=""; } else { $hidden=" style='display: none;'"; }?>
			...
			<?php if( get_option('wordpress_smsir_add_wpcf7') ) { $hidden=""; } else { $hidden=" style='display: none;'"; }?>
			...
			<?php if( get_option('wordpress_smsir_wc_no_stats') ) { $hidden=""; } else { $hidden=" style='display: none;'"; }?>
			...
			<?php if( get_option('wordpress_smsir_edd_no_stats') ) { $hidden=""; } else { $hidden=" style='display: none;'"; }?>
